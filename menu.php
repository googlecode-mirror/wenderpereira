      ...
      <div class="row-fluid">
        <div class="span3">
          <div class="well sidebar-nav">
           ...
           <li class="active"><a href="inicial.php"><i class="icon-th-list"></i>Mapeamento</a></li>
              <li><a href="verificamenu.php?m=-1"><i class="icon-plus-sign"></i>Indentifica&ccedil;&atilde;o</a></li>
