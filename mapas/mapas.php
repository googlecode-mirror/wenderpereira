...
<html>
    ...
    <body>
        ...
        <div class="container_12">
            <div class="grid_12">
                <div class="map" id="map" style="height: 490px; width: 100%;"></div>
            </div>
           <div class="grid_10">
					...
					$sql = "SELECT * FROM mapeamentopartei where unidadefederativa='$unidadeFederativa';";
						...
						<?
						 while ($array_exibir = mysql_fetch_array($Resultado)) {
							...
							?>
							addMarker('<?echo str_replace("'","",$array_exibir['endereco']);?><?echo ($array_exibir['unidadefederativa']); ?>','<img src="icons/m2.png" /><br/><b>Instituição: </b><?echo ($array_exibir['nomeintituicao']); ?><br/><b>Endereço: </b><?echo ($array_exibir['endereco']); ?><br/><b>Municipio: </b><?echo ($array_exibir['municipio']); ?><br/><b> Email:</b> <?echo ($array_exibir['email']); ?><br/><b>Telefone:</b> <?echo ($array_exibir['telefone']); ?>');
							<?
						}
					?>
			   }
