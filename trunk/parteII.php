...
<form name="form1" id="form1" class="table table-hover" method="post"  action="sql\parteII.php">
  <div class="container">
 <table width="80%" align="center" cellpadding="2" class="table table-hover">
    ...
    (marque no máximo os 3  itens de maior importância</label> 
    <p>
	  ...
	  <label><input name="qtd1[]" type="checkbox" value="1i" <? if(in_array("1i", $meuArray)){ echo "checked";}?>
      class="validate[maxCheckbox[3],minCheckbox[1]] checkbox"/>          
